# filterBeforeDate.py
# returns only the items from a list that have a date less than the given date
...
def filterBeforeDate(whichList, cutoffDate):
    ...
    # return the new list containing only items before the cutoff
    return result
...
'''
[{'name': 'Jane', 'date': '2024-05-01 10:00:00'}, {'name': 'Jennifer', 'date': '2023-03-12 15:30:00'}]
Press Enter to Exit
'''
