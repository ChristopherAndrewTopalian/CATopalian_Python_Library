...
# returns only the items from a dictionary that have a date outside of two given cutoff dates
...
def filterOutsideDates(whichList, startDate, endDate):
    ...
    # return the new dictionary containing only items outside the range
    return result

####

if __name__ == '__main__':
    # call the function with our people dictionary, using May 1 to May 8, 2024 as the range
...
'''
{'jennifer': {'name': 'Jennifer', 'date': '2023-03-12 15:30:00'}, 'tabitha': {'name': 'Tabitha', 'date': '2024-05-09 08:45:00'}}
'''
